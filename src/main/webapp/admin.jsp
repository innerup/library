	  ...
	  <script type="text/javascript">
		  $(function(){
			  $("#next").click(function(){
				  ...
				  page++;
				  location.href = "/library/admin?method=findAllBorrow&page="+page;
			  })
			  ...
			  $("#first").click(function () {
				  location.href = "/library/admin?method=findAllBorrow&page=1";
			  })

			  $("#last").click(function(){
				  var pages = parseInt($("#pages").html());
				  location.href = "/library/admin?method=findAllBorrow&page="+pages;
			  })
		  })
	  </script>
  </head>
    ...
    <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		<div class="navigation">
				当前位置:&nbsp;&nbsp;<a href="/library/admin?method=getBorrowed&page=1">还书管理</a>
		...
		<table class="table" cellspacing="0">
			...
			<c:forEach items="${list}" var="borrow">
				<tr>
					...
					<td>
						<a href="/library/admin?method=handle&id=${borrow.id}&state=1&page=${currentPage}">同意</a>
						<a href="/library/admin?method=handle&id=${borrow.id}&state=2&page=${currentPage}">拒绝</a>
					</td>
				</tr>
			</c:forEach>
