    ...
    <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		<div class="navigation">
				当前位置:&nbsp;&nbsp;<a href="/library/admin?method=findAllBorrow&page=1">借书管理</a>
		...
		<table class="table" cellspacing="0">
			...
			<tr>
				...
				<td>
						<a href="/library/admin?method=handleReturn&bid=${borrow.id}&rid=${borrow.reader.cardid}&bname=${borrow.book.name}&state=3&page=${currentPage}">归还</a>
				</td>
			</tr>
			</c:forEach>
