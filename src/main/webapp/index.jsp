  	...
  	<script type="text/javascript">
		$(function(){
			$("#next").click(function(){
				...
				if(page == pages){
					return;//在当前的页数和总页数相同时，返回这个点击事件
				}
				page++;
				location.href = "/library/book?method=findAll&page="+page;
			})
			...
			$("#first").click(function () {//首页的点击事件
				location.href = "/library/book?method=findAll&page=1";
			})
  	...
  	<div id="main">
		<div class="navigation">
				...
				<div id="readerBlock">欢迎回来&nbsp;:
					<a href="/library/book?method=findAllBorrow&page=1">${sessionScope.reader.name}</a>&nbsp;
					<a href="/library/logout">注销</a>
				</div>
		</div>
		<div class="img_block">
		...
		<table class="table" cellspacing="0">
			...
			<c:forEach items="${list}" var="book">
				<tr>
					...
					<td>
						<a href="/library/book?method=addBorrow&bookid=${book.id}">借阅</a>
					</td>
				</tr>
			</c:forEach>
